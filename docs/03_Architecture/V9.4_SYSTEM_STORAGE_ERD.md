# MSP System Storage & Entity Relationships (v9.4.0)
>
> **Status**: Canonical / v9.4.0
> **Role**: MSP Storage Governance & Data Ownership Map

เอกสารฉบับนี้แสดงโครงสร้างการถือครองข้อมูล (Data Ownership) ภายใต้การกำกับดูแลของ **MSP (Memory & Soul Passport)** ซึ่งเป็นศูนย์กลางการจัดการหน่วยความจำทั้งหมดของ EVA v9.4.0
...
flowchart TD
    ...
    subgraph LTM [Permanent Memory /agent/memory/]
        MSP -- "Snapshots" --> SESSION_MEM["Session Memory (Working)"]
    ...
    AGENTIC_RAG -- "Finetune" --> Consciousness
```

---

## 2. Entity Definitions (v9.4.0)
...
2. **Session Memory**: เก็บประวัติการสนทนาที่ผ่านมา (Moved from Episodic Layer after session ends)
...
เราเปลี่ยนจากการเก็บรวมๆ ใน `episodic_memory` มาเป็นการแยกหมวดหมู่ตาม **"ลำดับความสำคัญของตัวตน"** (Core vs Sphere vs Session) ซึ่งช่วยให้การดึงข้อมูล (Retrieval) แม่นยำขึ้นมหาศาลครับพี่!
